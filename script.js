...
function bindPlanEditor(){
  ...
  if(state.tool==="select"){
    ...
    function selUp(ev){
      ...
      if(state.selMemberId||state.selZoneId||state.selAnnotId){ state.selMemberId=null; state.selZoneId=null; state.selAnnotId=null; state.mSheet=null; state.mSheetMin=false; render(); }   // แตะที่ว่าง = เลิกเลือก
    }
    return;
  }
